...
/* =========================================================
OPENSTREETMAP / LEAFLET VARIABLES
========================================================= */
...
/*
Show selected marker again if already selected
*/
...
/*
Small delay prevents too many
requests while user is dragging
the marker.
*/
...
This link opens the location
without requiring Google Maps API.
*/

text +=
`\n*Location:* https://www.openstreetmap.org/?mlat=${lat}&mlon=${lng}#map=18/${lat}/${lng}`;
